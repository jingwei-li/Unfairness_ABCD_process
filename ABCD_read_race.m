function race = ABCD_read_race(subj_list, dohist, hist_fname)
...
demo_csv = '/mnt/eql/yeo12/data/ABCD/documents/release2.0/ABCDstudyNDA/acspsw03.txt';
...
race = CBIG_parse_delimited_txtfile( demo_csv, {race_hdr}, [], subj_hdr, subjects_csv, '\t');
