...
# Confounding variables (including income) are regressed from both behavioral scores and RSFC.
#
# Jingwei Li, 20211030
...
subj_ls=$ls_dir/subjects_pass_rs_pass_pheno_income.txt
csvname=$ls_dir/phenotypes_pass_rs_income.txt
cfds_ls=$ls_dir/confounds_list_income.txt
#cfds_ls=$ls_dir/confounds_list.txt
cfds_X_ls=$cfds_ls

FC_file=$proj_dir/mat/RSFC/pass_rs_pass_pheno_4952.mat
outdir=$proj_dir/models/KRR/20211030/reg_AgeSexMtIcvPEducInc_fr_y_FC
#outdir=$proj_dir/models/KRR/20211030/reg_AgeSexMtIcvPEduc_fr_y_FC

subfold_dir=$proj_dir/mat/matchANDsplit/20211030
subfold_stem=_pass_rs_pass_pheno_income
